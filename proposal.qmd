...
-   interesting thing 3 - SG1
-   interesting thing 4 - SG2
...
## Collaborative effort in terms of our introduction and conclusion. We plan to meet once we get our anlaysis done to format the flow of the presentation. Independly we will work on 2 interesting aspects of the data, as well as the data wrangling that goes along with it. This will be the same in regards to the report aspect of this project.

By November 13th (Monday) we will have our data wrangling, and two individual analysis done. We will meet that week to pull together the intro and conclusion. By the 21st (Tuesday) of November we aim to have the initial draft of the report done. We will turn this info in on the 24th (Friday) or earlier. We will make edits and be ready to film presentation on Dec 1st (Friday). Filming will occur on Dec 4th (Monday).

## Additional Comments

What concerns do you have about this project? This is your place to provide feedback about the project guidelines and ask clarifying questions for me to address either individually or in class, if the question is relevant to everyone. How quickly will we get feedback from the initial feedback on the 24th? If we turn in earlier, do we get feedback earlier?
