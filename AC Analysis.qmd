...
ui <- dashboardPage(
  dashboardHeader(title = "Physical characteristics of Olympians"
),

  dashboardSidebar(
      sidebarMenu(
       menuItem("Dashboard",tabName = "dashboard"),
        menuItem("Imperial to metric",  tabName = "English to metric conversion")
  )
),
...
tabItem(tabName = "English to metric conversion",
        h2("All data is in metric.. Here is the conversion for us dummies who dont use it!"),
          fluidPage(
            mainPanel(
