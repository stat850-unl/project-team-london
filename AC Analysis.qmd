...
sidebar <-  dashboardSidebar(
 ...
 body <- dashboardBody(
  ...
  tabItem(tabName = "about",
        ...
        width = 6,
        boxToolSize = "xl",
        "Hi! I'm Addison a PhD with a focus in dairy cattle nutrition. I enjoy metalcore music, tattoos, my australian shepherd bear, and science",
        footer = NULL
        ),
         userBox(
          title = userDescription(
 ...
 tabItem(tabName = "subitem1", 
    fluidPage(
      titlePanel("Influence of physical characteristics on medaling in Olympic games.. See how you stack up!"),
       ...
       column(4,
        chooseSliderSkin("Shiny", color = "white"),
          sliderInput("age",
                    "Age range", 
