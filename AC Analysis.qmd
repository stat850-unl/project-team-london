...
sidebar <-  dashboardSidebar(
 ...
 body <- dashboardBody(
  ...
  tabItem(tabName = "about",
          ...
          type = 2,
          image = "https://github.com/stat850-unl/project-team-london/blob/main/ACwJerseys.png",
        ),
        status = "primary",
        gradient = TRUE,
        background = "light-blue",
        boxToolSize = "xl",
        "Hi! I'm Addison a PhD with a focus in dairy cattle nutrition.",
 ...
 tabItem(tabName = "subitem1", 
    fluidPage(
      titlePanel("Influence of physical characteristics on medaling in Olympic games.. See how you stack up!"),
       ...
       column(4,
        chooseSliderSkin("Shiny", color = "#960018"),
          sliderInput("age",
                    "Age range", 
     ...
     box("border", 123, background = "maroon",
