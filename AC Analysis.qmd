...
sidebar <-  dashboardSidebar(
 ...
 body <- dashboardBody(
  ...
  tabItem(tabName = "about",
          fluidPage(
            titlePanel("Welcome to our project! The goal of this app is to allow you to compare both your and your friend's physcial characteristics with historical olympic medalists."),
            fluidRow(
            column(6,
            h3("Addison Carroll: PhD student in ruminant nutrition with a focus in dairy cattle metabolism"),
            img(src = 'ACwJerseys.png', height = '100px', width = "100px" )
            ),
            column(6,
