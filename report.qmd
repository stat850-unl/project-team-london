...
![all 230 nations](#allofthenations.png) ![all 1184 teams](#alloftheteams.png)
...
For the data wrangling associated with the nickname analysis the str_count function was used to test for sets of " or ' which was indicative of a nickname [@stringr].
...
#\| echo: false #\| label: fig-conflict #\| fig-width: 9 #\| fig-height: 7 \# Change the figure dimensions using fig-width/height #\| out-width: 80% #\| fig-cap: "This figure shows the influence of global conflict on Olympic game participation in males and females from 1896 to 2016. The figure is drawn with `ggplot2` [@ggplot2-package]."
