...
shinyApp(ui, server)
```
## These are the images from the shiny application output. I will run this scenario in real time in presentation. The first output is from Richard Carroll (Addison's dad), and the second from Sydney's dad ....
```{R}
